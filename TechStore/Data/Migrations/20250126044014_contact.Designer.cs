...
namespace TechStore.Data.Migrations
{
    ...
    [Migration("20250126044014_contact")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechStore.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TechStore.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechStore.Models.CartDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechStore.Models.ContactFormModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TechStore.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TechStore.Models.Stock", b =>
                {
                    b.HasOne("TechStore.Models.Product", "Product")
                        .WithOne("Stock")
                        .HasForeignKey("TechStore.Models.Stock", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
